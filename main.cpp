...
int main() {
    ...
    size_t n, m;
    std::cout << "Vvedite kolichestvo ryadov: ";
    std::cin >> n;
    ...
    Matrix multiply = Mult(mat1, mat2);
    ...
    std::cout << "multiply:\n";
    for (size_t i = 0; i < multiply.n_; ++i) {
        for (size_t j = 0; j < multiply.m_; ++j) {
            std::cout << multiply.data_[i][j] << " ";
        }
        std::cout << std::endl;
    }
